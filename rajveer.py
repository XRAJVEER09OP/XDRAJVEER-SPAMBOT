...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await str1(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str1(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if smexx:
        ...
        try:
            ...
            await str2.start()
            await str2(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str2(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  str3.start()
            await str3(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str3(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await str4.start()
            await str4(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
)            await str4(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await str5.start()
            await str5(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str5(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if sixth:
        ...
        try:
            ...
            await str6.start()
            await str6(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str6(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if seven:
        ...
        try:
            ...
            await str7.start()
            await str7(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str7(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if eight:
        ...
        try:
            ...
            await str8.start()
            await str8(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str8(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if ninth:
        ...
        try:
            ...
            await str10.start()
            await str10(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str10(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if tenth:
        ...
        try:
            ...
            await str9.start()
            await str9(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str9(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if eleventh:
        ...
        try:
            ...
            await str11(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str11(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            str11 = "eleventh"
    ...
    if twelve:
        ...
        try:
            ...
            await str12.start()
            await str12(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str12(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if thirteen:
        ...
        try:
            ...
            await  str13.start()
            await str13(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str13(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if fourteen:
        ...
        try:
            ...
            await str14.start()
            await str14(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str14(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if fifteen:
        ...
        try:
            ...
            await str15.start()
            await str15(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str15(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if sixteen:
        ...
        try:
            ...
            await str16.start()
            await str16(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str16(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if seventeen:
        ...
        try:
            ...
            await str17.start()
            await str17(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str17(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if eighteen:
        ...
        try:
            ...
            await str18.start()
            await str18(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str18(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if nineteen:
        ...
        try:
            ...
            await str19.start()
            await str19(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str19(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twenty:
        ...
        try:
            ...
            await str20.start()
            await str20(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str20(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentyone:
        ...
        try:
            ...
            await str21(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str21(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            str21 = "twentyone"
    ...
    if twentytwo:
        ...
        try:
            ...
            await str22.start()
            await str22(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str22(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentythree:
        ...
        try:
            ...
            await  str23.start()
            await str23(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str23(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentyfour:
        ...
        try:
            ...
            await str24.start()
            await str24(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str24(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentyfive:
        ...
        try:
            ...
            await str25.start()
            await str25(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str25(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentysix:
        ...
        try:
            ...
            await str26.start()
            await str26(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str26(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentyseven:
        ...
        try:
            ...
            await str27.start()
            await str27(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str27(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentyeight:
        ...
        try:
            ...
            await str28.start()
            await str28(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str28(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
    ...
    if twentynine:
        ...
        try:
            ...
            await str29.start()
            await str29(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str29(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
    ...
    if thirty:
        ...
        try:
            ...
            await str30.start()
            await str30(functions.channels.JoinChannelRequest(channel="@RAJVEERGODSPAM"))
            await str30(functions.channels.JoinChannelRequest(channel="@RAJVEERSPAMBOT"))
